		...
		<div class="row fixed-top">
			<div class="col-2" id="itemsPanel">
				<div class="list-group">
				  	...
				  	<button href="adminPanel.php" class="btn separacion btn-block btn-outline-dark">Inicio</button>
					...
					<button href="cerrarSesion.php" class="btn separacion btn-block btn-outline-dark">Cerrar Sesión</button>
				</div>
			</div>
			<div class="col-10">
				<div>
